...
const renderTickets = (tickets) => {
    ...
    tickets.forEach(ticket => {
        ...
        tr.innerHTML = `
            <td class="px-4 py-3">${sanitizeInput(ticket.number)}</td>
            <td class="px-4 py-3">${sanitizeInput(ticket.service)} (${sanitizeInput(ticket.department_name)})</td>
            <td class="px-4 py-3">${sanitizeInput(ticket.status)}</td>
            <td class="px-4 py-3">${ticket.counter || 'N/A'}</td>
